...
<a class="group" href="{{ route('projects.show', ['project' => $project->uri_name]) }}">
    <div class="shadow-xl h-72 w-72 sm:w-96 sm:h-96 lg:w-84 lg:h-84 text-center relative flex flex-col justify-center bg-center rounded-sm bg-cover p-5 text-white group-hover:scale-105 group-active:scale-105 transition-transform">
        ...
        <img class="absolute h-full w-full top-0 left-0 z-0" src="{{ $project->getCoverImage() }}" />
    </div>
</a>