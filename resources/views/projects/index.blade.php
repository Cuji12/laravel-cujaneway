...
@section('content')
    <main class="relative flex flex-row-reverse">
        <div class="bg-pink flex flex-wrap xl:p-20 p-6 pb-96 xl:w-10/12 2xl:w-9/12 3xl:w-9/12 xl:py-44 xl:items-end w-11/12 lg:w-10/12 relative rounded-md">
            ...
            <div class="mx-auto sm:w-9/12 max-w-screen-md mt-52 sm:mt-72 lg:mt-80 flex flex-col w-full items-center justify-center lg:flex-row xl:mt-48 flex-wrap">
                @foreach($projects as $project) 
                    <x-project :project="$project" />
                @endforeach
            </div>
            <img src="/images/doodles/projects-squares-mobile.svg" alt="Tree" class="absolute bottom-20 w-72 xl:hidden">
            <img src="/images/doodles/projects-squares-desktop.svg" alt="Tree" class="hidden absolute bottom-20 n-left-52 w-72 xl:block 4xl:w-80">
        </div>
    </main>    
@endsection