...
@section('content')
    ...
    <section class="flex flex-row-reverse">
        <div class="bg-pink flex flex-wrap xl:p-20 p-6 pb-96 xl:w-10/12 2xl:w-9/12 3xl:w-4/6 xl:py-44 relative xl:items-end w-11/12 py-24">
            <h1 class="font-bold xl:text-6xl absolute xl:top-20 xl:n-left-24 tracking-widest top-10 n-left-4 text-3xl">Cu Janeway</h1>
            <div class="flex flex-wrap xl:flex-nowrap relative">
                <img class="xl:w-80 3xl:w-92 mb-6 sm:w-72" src="/images/me.jpg" alt="Picture of me during a hike."/>
                <p class="text-green w-full font-medium mb-2 xl:absolute top-0 4xl:text-3xl xl:text-2xl xl:rotate-90 xl:t-origin-tl 4xl:n-right-64 xl:n-right-52 tracking-wider">Web Developer</p>
            </div>
            ...
            <img class="absolute n-bottom-4 right-0 w-64 xl:n-bottom-4 2xl:n-left-80 2xl:w-96 xl:w-72 xl:n-left-52" src="/images/doodles/home.svg" alt="Graphical representation of me."/>
        </div>
    </section>
@endsection()
